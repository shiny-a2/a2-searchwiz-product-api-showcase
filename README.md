...
- `samples/php/` — short public-safe PHP snippets for snapshot DTOs, request boundaries, and batch state.
...
- **Phase 3:** sanitized snippets for product snapshot shaping, request access policy, and batch rebuild state.
